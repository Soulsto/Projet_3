...
def liver_page():
    ...
    if submit_button:
        ...
        if foie_prediction[0] == 1:
            ...
            st.markdown('<div class="center"><p style="color: white; font-size: 16px;">Nous suspectons une maladie du foie d\'après les analyses préliminaires. Votre patient doit passer des examens complémentaires.</p></div>', unsafe_allow_html=True)
        else:
            col_center = st.columns([3, 1, 3])
            with col_center[1]:
                st.image("foie.png")
            st.markdown('<div class="center"><p style="color: green; font-size: 24px;">Pas de suspicion</p></div>', unsafe_allow_html=True)
            st.markdown('<div class="center"><p style="color: white; font-size: 16px;">Les analyses préliminaires indiquent que le patient n\'a pas de maladie du foie.</p></div>', unsafe_allow_html=True)
...
def heart_page():
    ...
    if submit_button:
        ...
        if renale_prediction[0] == 1:
            ...
            st.markdown('<div class="center"><p style="color: red; font-size: 24px;">Suspicion détectée</p></div>', unsafe_allow_html=True)
            st.markdown('<div class="center"><p style="color: white; font-size: 16px;">Nous suspectons une maladie du coeur d\'après les analyses préliminaires. Votre patient doit passer des examens complémentaires.</p></div>', unsafe_allow_html=True)
        else:
            col_center = st.columns([3, 1, 3])
            with col_center[1]:
                st.image("coeur.png")  # Add an appropriate heart image
            st.markdown('<div class="center"><p style="color: green; font-size: 24px;">Pas de suspicion</p></div>', unsafe_allow_html=True)
            st.markdown('<div class="center"><p style="color: white; font-size: 16px;">Les analyses préliminaires indiquent que le patient n\'a pas de maladie du coeur.</p></div>', unsafe_allow_html=True)
...
def diabetes_page():
    ...
    if submit_button:
        ...
        if diabetes_prediction[0] == 1:
            ...
            st.markdown('<div class="center"><p style="color: red; font-size: 24px;">Suspicion détectée</p></div>', unsafe_allow_html=True)
            st.markdown('<div class="center"><p style="color: white; font-size: 16px;">Nous suspectons du diabète d\'après les analyses préliminaires. Votre patient doit passer des examens complémentaires.</p></div>', unsafe_allow_html=True)
        else:
            col_center = st.columns([3, 1, 3])
            with col_center[1]:
                st.image("diabete.png")  # Add an appropriate diabetes image
            st.markdown('<div class="center"><p style="color: green; font-size: 24px;">Pas de suspicion</p></div>', unsafe_allow_html=True)
            st.markdown('<div class="center"><p style="color: white; font-size: 16px;">Les analyses préliminaires indiquent que le patient n\'a pas de diabète.</p></div>', unsafe_allow_html=True)
...
def breast_cancer_page():
    ...
    if submit_button:
        ...
        if seins_prediction[0] == 1:
            ...
            st.markdown('<div class="center"><p style="color: red; font-size: 24px;">Suspicion détectée</p></div>', unsafe_allow_html=True)
            st.markdown('<div class="center"><p style="color: white; font-size: 16px;">Nous suspectons un cancer du sein d\'après les analyses préliminaires. Votre patient doit passer des examens complémentaires.</p></div>', unsafe_allow_html=True)
        else:
            col_center = st.columns([3, 1, 3])
            with col_center[1]:
                st.image("seins.png")  # Add an appropriate breast cancer image
            st.markdown('<div class="center"><p style="color: green; font-size: 24px;">Pas de suspicion</p></div>', unsafe_allow_html=True)
            st.markdown('<div class="center"><p style="color: white; font-size: 16px;">Les analyses préliminaires indiquent que la patiente n\'a pas de cancer du sein.</p></div>', unsafe_allow_html=True)
...
def kidney_page():
    ...
    if submit_button:
        ...
        if reins_prediction[0] == 1:
            col_center = st.columns([3, 1, 3])
            with col_center[1]:
                st.image("reins.png")  # Add an appropriate breast cancer image
            st.markdown('<div class="center"><p style="color: red; font-size: 24px;">Suspicion détectée</p></div>', unsafe_allow_html=True)
            st.markdown('<div class="center"><p style="color: white; font-size: 16px;">Nous suspectons une maladie rénale d\'après les analyses préliminaires. Votre patient doit passer des examens complémentaires.</p></div>', unsafe_allow_html=True)
        else:
            col_center = st.columns([3, 1, 3])
            with col_center[1]:
                st.image("reins.png")  # Add an appropriate breast cancer image
            st.markdown('<div class="center"><p style="color: green; font-size: 24px;">Pas de suspicion</p></div>', unsafe_allow_html=True)
            st.markdown('<div class="center"><p style="color: white; font-size: 16px;">Les analyses préliminaires indiquent que le patient n\'a pas de maladie rénale.</p></div>', unsafe_allow_html=True)
